      ...
      <div className="top-actions">
        <button className="chevron-btn" onClick={onBack} aria-label="Back">
          <svg className="chevron-svg" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="card glass account-card settings-card">`n        <button type="button" className="settings-row" onClick={onOpenFeedback}>`n          <span className="settings-left">`n            <span className="settings-icon">`n              <IconMessage />`n            </span>`n            <span className="settings-label">Feedback & Suggestions</span>`n          </span>`n          <span className="settings-chevron">`n            <IconChevron />`n          </span>`n        </button>`n`n        <div className="settings-divider" />`n`n        <button type="button" className="settings-row" onClick={onOpenSupport}>`n          <span className="settings-left">`n            <span className="settings-icon">`n              <IconHelp />`n            </span>`n            <span className="settings-label">Report an Issue</span>`n          </span>`n          <span className="settings-chevron">`n            <IconChevron />`n          </span>`n        </button>`n      </div>`n    </main>
  );
}
