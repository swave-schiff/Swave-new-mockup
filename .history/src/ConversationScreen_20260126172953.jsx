    ...
    <main className="conversation-screen main-with-tabbar">
      ...
      <ConfirmSheet
        ...
        lines={[
          ...
          "• “Your side only” will remove the entire conversation fr your devices only.",
          "• “Both sides” removes it from their devices too, without even prompting them.",
        ]}
        primary="Both sides"
      ...
      <ConfirmSheet
        ...
        lines={[
          "Choose where to delete:",
          "• “Your side only” removes only on your device.",
